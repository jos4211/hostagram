	...
	<div class="header_area box_inner clear">
		<nav>
			...
			<div class="header_search">
				...
				<form action="../main_search.jsp" method="GET">
			...
			<div class="header_meun">
				<div class="h_meun">
					...
					<div class="h_meunlist">
						<a class="m_like" href="#"> <div aria-label="활동피드"
								class="ico_btn hd_heart1" fill="#262626" height="22" viewBox="0 0 48 48"
								width="22">
                        ...
                        <div class="hd_heart_sub1">
							<%
								...
								<div class="sub_prices">
									...
									<div class="pr1">
										<a href="otherperson.jsp?userid=<%=rs1.getString("otherfollow")%>"><img src='../uploads/<%=rs1.getString("otherpf") %>' alt="img"></a>
									</div>
									<div class="pr2">
